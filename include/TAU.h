...
#define TAU_VERSION "2.30.1-git"
#define TAU_MAKEFILE "/home/sramesh/AUTOPERF/TAU_INSTALL/x86_64/lib/Makefile.tau-mpi-pthread-cupti"
...
#define TAU_ENABLE_PLUGIN_FOR_SPECIFIC_EVENT(ev, name, id)
#define TAU_DISABLE_PLUGIN_FOR_SPECIFIC_EVENT(ev, name, id)
#define TAU_ENABLE_ALL_PLUGINS_FOR_SPECIFIC_EVENT(ev, name)
#define TAU_DISABLE_ALL_PLUGINS_FOR_SPECIFIC_EVENT(ev, name)
#define TAU_ENABLE_PLUGIN_FOR_TRIGGER_EVENT(ev, hash, id)
#define TAU_DISABLE_PLUGIN_FOR_TRIGGER_EVENT(ev, hash, id)
#define TAU_ENABLE_ALL_PLUGINS_FOR_TRIGGER_EVENT(ev, hash)
#define TAU_DISABLE_ALL_PLUGINS_FOR_TRIGGER_EVENT(ev, hash)
#define TAU_ADD_REGEX(r)
#define TAU_CHECK_FOR_MATCHING_REGEX(input)
#define TAU_CREATE_TRIGGER(name)
#define TAU_TRIGGER(id, data)
