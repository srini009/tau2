...
PCXX_OPT=-g
USER_OPT=-O2 -g
TAUROOT=/home/sramesh/AUTOPERF/tau2
#######################################################################
...
MPIEXAMPLES = examples/pi examples/NPB2.3 #ENDIF##MPI#
...
TAUCUDA=src/wrappers/cuda #ENDIF##CUDA#
...
SUBDIR  = $(TRACEINPUT) $(BASIC) $(PCXX) $(HPCXX) $(ANSIC) $(VTFCONVERTER) \
          ...
          $(GPIWRAPPER) $(ARMCIWRAPPER) $(DMAPPWRAPPER) $(UGNIWRAPPER) $(UPCWRAPPER) \
          $(GOMP_WRAPPER) $(OTF2PROFILE) $(MPC_MPI_WRAPPER) $(APEX) \
          $(SHMEM_WRAPPER) $(PLUGINS)
